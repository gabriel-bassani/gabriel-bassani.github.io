...
export function TechnologiesSection() {
  const { language } = useLanguage();
    ...
    return (
        <>
            <h1 className="text-center mb-8 pt-10">{translations[language].technologies.title}</h1>
            <p className="px-4 sm:px-6 lg:px-10">{translations[language].technologies.top}</p>
            <h2 className="mt-10">Frontend</h2>
            <div className="flex flex-wrap gap-6 sm:gap-8 md:gap-10 lg:gap-20 xl:gap-40 justify-center my-10">
            ...
            <p className="px-4 sm:px-6 lg:px-10">
